...
<table>
<tr>
<td><input type="text"  placeholder="请输入搜索条件" autocomplete="off" class="layui-input" name="bespeak" ></td><td>&nbsp;</td>
...
<div class="layui-form">
							...
							<tr>
								...
								<td>
									<div class="layui-btn-group">
										<div class="layui-btn-group">
										<c:if test="${b.bespeakState==0&&admin.adminRole!=2}">
	  ...
	  <table class="layui-table"   border="0" cellspacing="0" cellpadding="0"  width="900px">
       ...
       <c:if test="${requestScope.BespeakAllMsg.currPage != 1}">
           ...
           <a href="${pageContext.request.contextPath }/selectAllbespeak?currentPage=${requestScope.BespeakAllMsg.currPage-1}">[上一页]</a>&nbsp;&nbsp;
       </c:if>
       ...
       <c:if test="${requestScope.BespeakAllMsg.currPage != requestScope.BespeakAllMsg.totalPage&&requestScope.BespeakAllMsg.totalPage!=0}">
           <a href="${pageContext.request.contextPath }/selectAllbespeak?currentPage=${requestScope.BespeakAllMsg.currPage+1}">[下一页]</a>&nbsp;&nbsp;
           <a href="${pageContext.request.contextPath }/selectAllbespeak?currentPage=${requestScope.BespeakAllMsg.totalPage}">[尾页]</a>&nbsp;&nbsp;
       </c:if>
   </span>
        </td>
    </tr>
