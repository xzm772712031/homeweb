...
<c:if test="${!empty requestScope.BespeakAllMsg}">
	  ...
	  <table class="layui-table"   border="0" cellspacing="0" cellpadding="0"  width="900px">
       ...
       <c:if test="${requestScope.BespeakAllMsg.currPage != 1}">
           <a href="${pageContext.request.contextPath }/showbespeakComplete?currentPage=1">[首页]</a>&nbsp;&nbsp;
           <a href="${pageContext.request.contextPath }/showbespeakComplete?currentPage=${requestScope.BespeakAllMsg.currPage-1}">[上一页]</a>&nbsp;&nbsp;
       </c:if>

       <c:if test="${requestScope.BespeakAllMsg.currPage != requestScope.BespeakAllMsg.totalPage}">
           <a href="${pageContext.request.contextPath }/showbespeakComplete?currentPage=${requestScope.BespeakAllMsg.currPage+1}">[下一页]</a>&nbsp;&nbsp;
           <a href="${pageContext.request.contextPath }/showbespeakComplete?currentPage=${requestScope.BespeakAllMsg.totalPage}">[尾页]</a>&nbsp;&nbsp;
       </c:if>
   </span>
        </td>
    </tr>
